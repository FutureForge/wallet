...
const DialogContent = forwardRef<ContentElement, ContentProps>((props, ref) => {
  ...
  return (
    <DialogPrimitive.Portal>
      <DialogPrimitive.Overlay className="fixed inset-0 bg-black/80 flex items-center justify-center data-[state=open]:animate-overlay-show data-[state=closed]:animate-overlay-hide z-50 px-4">
        <DialogPrimitive.Content
          className={cn(
            'relative bg-new-secondary border border-dialog-border rounded-[24px] max-h-[95vh] flex flex-col',
